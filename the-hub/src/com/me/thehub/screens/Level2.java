...
public class Level2 extends AbstractLevel {
	...
	// level triggers
	public Rectangle level2boss;

	public Level2(Player player, SpriteBatch batch) 
	{		
		...
		level2boss = new Rectangle(collision.getWidth() * collision.getTileWidth() - 10, 6*32, 32, 64);
	}

	public Screens checkTriggers()
	{
		if(Intersector.overlaps(level2boss, player.bounds)) {
			loaded = false;
			return Screens.LEVEL2B;
		}
		else return Screens.LEVEL2;
	}
