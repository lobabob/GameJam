...
public class Hub1 extends AbstractLevel {
	...
	public Hub1(Player player, SpriteBatch batch) 
	{		
		...
		map = load.load("maps/TheHub/TheHub.tmx");
		...
		level3boss = new Rectangle(collision.getWidth() * collision.getTileWidth() - 9*32, 12*32, 6*32, 2*64);
	}
