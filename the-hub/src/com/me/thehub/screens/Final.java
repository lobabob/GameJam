...
public class Final extends AbstractLevel {
	...
	public Final(Player player, SpriteBatch batch) 
	{		
		...
		map = load.load("maps/LastRoom/FourthBoss.tmx");
		...
		gameover = new Rectangle(collision.getWidth() * collision.getTileWidth() - 10, 32, 32, 64);
	}

	public Screens checkTriggers()
	{
		if(Intersector.overlaps(gameover, player.bounds)) {
			loaded = false;
			return Screens.CREDITS;
		}
		else return Screens.FINAL;
	}
