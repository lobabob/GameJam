...
public class Level1 extends AbstractLevel {
	...
	// level triggers
	public Rectangle level1boss;

	public Level1(Player player, SpriteBatch batch) 
	{		
		...
		map = load.load("maps/LevelOne/LevelOne.tmx");
		...
		level1boss = new Rectangle(collision.getWidth() * collision.getTileWidth() - 10, 32, 32, 64);
	}

	public Screens checkTriggers()
	{
		if(Intersector.overlaps(level1boss, player.bounds)) {
			loaded = false;
			return Screens.LEVEL1B;
		}
